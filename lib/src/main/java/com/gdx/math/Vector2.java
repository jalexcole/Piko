...
import com.gdx.utils.GdxRuntimeException;
...
public class Vector2 implements Vector<Vector2>{
    ...
    public final static Vector2 UP = new Vector2(0f, -1f);
    public final static Vector2 DOWN = new Vector2(0f, 1f);
    public final static Vector2 LEFT = new Vector2(-1f, 0f);
    public final static Vector2 RIGHT = new Vector2(1f, 0f);
